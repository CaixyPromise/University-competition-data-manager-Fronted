...
/** getMeByRequest GET /api/user/get/me */
...
/** listUserDetailsByPage POST /api/user/list/page/all */
export async function listUserDetailsByPageUsingPOST(
  body: API.UserDetailsQueryRequest,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponsePageUserDepartmentMajorVO_>('/api/user/list/page/all', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
